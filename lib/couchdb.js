...
module.exports = function( settings ) {
    ...
    var req = function( m, opts ) {
        return function( o, cb ) {
            var r = __request.apply( this, arguments );
            m.trigger( "request", m, r, opts );
            return r;
        }
    }

    var __request = function( opts, cb ) {
    ...
    return backsync()
        .search( function( collection, opts, cb ) {
            var request = req( collection, opts );
            ...
            var next = function( url, qs ) {
                ...
                var r = request({ url: _url }, function( err, body ) {
                ...
                collection.trigger( "request", collection, r, opts );
            };

            next( opts.url, qs );
        })
        .delete( function( model, opts, cb ) {
            var request = req( model, opts );
            if ( !model.get( "rev" ) ) {
